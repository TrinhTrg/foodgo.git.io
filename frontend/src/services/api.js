...
export const authAPI = {
  ...
  requestPasswordReset: async (email) => {
    return apiCall('/users/forgot-password/request', {
      method: 'POST',
      body: { email },
    });
  },
  ...
  verifyPasswordResetCode: async (email, code) => {
    return apiCall('/users/forgot-password/verify', {
      method: 'POST',
      body: { email, code },
    });
  },

  checkPasswordMatch: async (email, newPassword) => {
    return apiCall('/users/forgot-password/check-password', {
      method: 'POST',
      body: { email, newPassword },
    });
  },
  ...
  resetPasswordWithCode: async (email, code, newPassword) => {
    return apiCall('/users/forgot-password/reset', {
      method: 'POST',
